...
class ReadAASENCAMutSelDSBDPOmegaArgParse : public ReadArgParse {
  public:
    explicit ReadAASENCAMutSelDSBDPOmegaArgParse(CmdLine& cmd) : ReadArgParse(cmd) {}
...
int main(int argc, char* argv[]) {
    CmdLine cmd{AASENCAMutSelMultipleOmega::GetModelName(), ' ', "0.1"};
    ReadAASENCAMutSelDSBDPOmegaArgParse read_args(cmd);
    cmd.parse(argc, argv);
    ...
    AASENCAMutSelMultipleOmega model(is);
