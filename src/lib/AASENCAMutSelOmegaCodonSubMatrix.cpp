...
void AASENCAMutSelOmegaCodonSubMatrix::ComputeStationary() const {
...
void AASENCAMutSelOmegaCodonSubMatrix::ComputeArray(int i) const {
    double total = 0;
...
std::tuple<double, double> AASENCAMutSelOmegaCodonSubMatrix::GetFlowDNDS() const {
    UpdateStationary();
...
std::tuple<double, double> AASENCAMutSelOmegaCodonSubMatrix::GetRelativeFlowDNDS() const {
    UpdateStationary();
...
double AASENCAMutSelOmegaCodonSubMatrix::GetPredictedDNDS() const {
    double dn = 0, ds = 0;
    std::tie(dn, ds) = GetFlowDNDS();
    return dn / ds;
}

double AASENCAMutSelOmegaCodonSubMatrix::GetPredictedDS() const {
    double dn = 0, ds = 0;
    std::tie(dn, ds) = GetFlowDNDS();
    return ds;
}

double AASENCAMutSelOmegaCodonSubMatrix::GetPredictedRelativeDNDS() const {
    double dn = 0, ds = 0;
    std::tie(dn, ds) = GetRelativeFlowDNDS();
    return dn / ds;
}

double AASENCAMutSelOmegaCodonSubMatrix::GetPredictedRelativeDN() const {
    double dn = 0, ds = 0;
    std::tie(dn, ds) = GetRelativeFlowDNDS();
    return dn;
}

double AASENCAMutSelOmegaCodonSubMatrix::GetPredictedRelativeDS() const {
    double dn = 0, ds = 0;
    std::tie(dn, ds) = GetRelativeFlowDNDS();
    return ds;
}